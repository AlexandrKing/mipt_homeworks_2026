...
def _build_modes() -> Mapping[str, ChatMode]:
    return MappingProxyType(
        {
            ...
            'code': ChatMode(
                ...
                system_prompt=(
                    ...
                    'Объясняй важные решения, указывай возможные ошибки. '
                    'Предлагай команды для запуска.'
                ),
            ),
            'teacher': ChatMode(
                name='teacher',
                title='преподаватель',
                system_prompt=(
                    'Ты терпеливый преподаватель. Объясняй материал пошагово. '
                    'Добавляй небольшие примеры. '
